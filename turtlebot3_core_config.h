...
#define CRSO3_FACTOR                     20        //mV/deg/s
#define CRSO9_FACTOR                     10        //mV/deg/s

#define ANALOG_CONV                      3.22265625       //mV/unit
// #define DEBUG                            
...
// My Additon: analog CRS gyros
sensor_msgs::Imu CRS03_msg; 
ros::Publisher CRS03_pub("CRS03",&CRS03_msg); 
sensor_msgs::Imu CRS09_msg; 
ros::Publisher CRS09_pub("CRS09",&CRS09_msg); 
